...
\cvevent{Petnica Science Center}{Assistant at Department of Applied Physics and Electronics}{September 2018 -- present}{Valjevo, Serbia}

\begin{itemize}
    %\setlength{\itemindent}{0.5em}
    \item   \small{Gave lecture in Linear Algebra}
...
\cvevent{Renesas MCU Rally}{Team member of Faculty's Robotics department}{October 2019 -- present}{Belgrade, Serbia}


\begin{itemize}
    %\setlength{\itemindent}{0.5em}
    \item   \small{Writing physics simulation of model vehicle with sensors and localization}
    \item   \small{DC motor testing and measurement}
    %\item   \small{\textit{MATLAB, Simulink}}
\end{itemize}
...
\begin{itemize}
  ...
  %\item \small{\textit{Python, TesnorFlow}}
\end{itemize}
...
\cvevent{The Analysis of Ball Balancing Robot's Control System}{Petnica Science Center}{summer 2017}{Valjevo, Serbia}
...
\begin{itemize}
    ...
    %\item \small{\textit{MATLAB, Python}}
\end{itemize}
...
\cvevent{Word Recognition using Gyroscope Signals}{Petnica Science Center}{summer 2016}{Valjevo, Serbia}
...
\begin{itemize}
    ...
    %\item \small{\textit{MATLAB, MicroC}}
\end{itemize}
